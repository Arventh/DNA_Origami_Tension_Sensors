...
folder = '/home/arventh/Documents/Data/2023_Hairpin/33nm/3-0_force_rep3' #raw_input directory
txt = '3-0_out_Observables_1.dat'
os.chdir(folder)
data = open(txt, 'r')
i, x, y, y_peak, err = 0,[],[],[],[]
...
t1_init = np.array([-61.1968333132652, 19.6714688076207, 22.3375898293947]) #moving trap
t2_init = np.array([83.300436779296, 109.097870956689, 61.7046904362213]) #fixed trap
...
for line in data:
    ...
    y.append(force)
    if Zf[2] <= 45   and i == 0: #Zf[2] is HB count
        Rupture_F = force
...
#90BF2A #144C59
#f9f871 #c34a36
peaks, ht = find_peaks(y_pk, height=[10,16], prominence=1) #finds a list of peaks satisfying the criteria
