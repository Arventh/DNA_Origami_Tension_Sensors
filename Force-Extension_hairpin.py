...
folder = '/home/arventh/Documents/Data/2023_Hairpin/JustHairpin/3-1_force_rep3' #raw_input directory
txt = '3-1-1_out_Observables_1.dat'
os.chdir(folder)
data = open(txt, 'r')
i, x, y, y_peak, err = 0,[],[],[],[]
...
t1_init = np.array([3.2706527709960938, -1.2407134771347046, -0.9822177886962891]) #moving trap
t2_init = np.array([0.7120456695556641, 0.2895764112472534, -0.9903163909912109]) #fixed trap
...
for line in data:
    ...
    y.append(force)
    if Zf[2] <= 25   and i == 0: #Zf[2] is HB count
        Rupture_F = force
...
#90BF2A #144C59
#f9f871 #c34a36
peaks, ht = find_peaks(y_pk, height=[16,18], prominence=1) #finds a list of peaks satisfying the criteria
