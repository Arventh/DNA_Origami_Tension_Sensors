...
folder = '/home/arventh/Documents/Data/2023_Hairpin/43nm_dsDNA/3-1_force_rep3' #raw_input directory
...
t1_init = np.array([8.55342166639502, 30.091665093361, 41.0148894951401]) #moving trap
t2_init = np.array([14.4770006829191, 6.96923858448832, 26.5812229504158]) #fixed trap
...
#90BF2A #144C59
#f9f871 #c34a36
peaks, ht = find_peaks(y_pk, height=[11.3,16], prominence=1) #finds a list of peaks satisfying the criteria
