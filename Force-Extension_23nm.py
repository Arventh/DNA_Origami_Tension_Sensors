...
folder = '/home/arventh/Documents/Data/2023_Hairpin/23nm/3-1_force_rep2' #raw_input directory
...
t1_init = np.array([-4.46090973021749, -1.38288513749999, 3.98198094123916]) #moving trap
t2_init = np.array([2.91693962613911, -1.16735564999901, -2.60011995897037]) #fixed trap
...
for line in data:
    ...
    y.append(force)
    if Zf[2] <= 23 and i == 0: #Zf[2] is HB count
        Rupture_F = force
...
#90BF2A #144C59
#f9f871 #c34a36
peaks, ht = find_peaks(y_pk, height=[12,12.6], prominence=1) #finds a list of peaks satisfying the criteria
